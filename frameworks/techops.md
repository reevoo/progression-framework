...
topics:
  ...
  - name: "knowledge"
    ...
    content:
      ...
      - level: 5
        criteria:
          - "Constantly innovating, learning, teaching and looking for new ways to do things which haven't been done before. Shares these new ways of doing things internally and externally. Is a recognised industry expert outside of Reevoo."
    ...
    content:
      - level: 1
        criteria:
          ...
          - "Builds relationships within Reevoo and contributes to building a supportive, knowledgeable and engaged peer group"
    ...
    content:
      - level: 1
        criteria:
          ...
          - "Brings new ideas to the table to improve technical aspects of Reevolver’s day to day life"
      - level: 2
        criteria:
      ...
      - level: 5
        criteria:
          ...
          - "Given as a reason for other engineers to join Reevoo"
    ...
    content:
      ...
      - level: 4
        criteria:
          ...
          - "Instills Reevoo engineering principles into the team, even for operational tasks"
...
### How does it work?
The framework covers all the things we’re looking for from engineers at Reevoo. We’re interested in these five elements:
...
- There are many different ways to progress and be valuable to Reevoo as you grow, including deep technical knowledge and ability, technical leadership and people management. All are equally valuable paths in Reevoo's engineering team.
